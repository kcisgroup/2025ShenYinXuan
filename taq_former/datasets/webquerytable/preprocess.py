...
if __name__ == '__main__':
    process_queries('webquerytable/WQT.dataset.query.tsv')
    process_qtrels('webquerytable/WQT.dataset.query-table.tsv')
    process_tables('webquerytable/WQT.dataset.table.tsv')
